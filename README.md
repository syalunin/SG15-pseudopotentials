...
### Runing
The pseudopotentials with core wavefunctions are generated using shell scripts. The script `run.sh` generates pseudopotentials for selected chemical elements, while `run_all.sh` generates pseudopotentials for all elements in the folder `elements`.
